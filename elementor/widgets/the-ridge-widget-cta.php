	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Sign up now and embark on a journey of knowledge, inspiration, and exclusive benefits. Welcome to The Ridge family!', 'the-ridge-core' ),
			]
		);
